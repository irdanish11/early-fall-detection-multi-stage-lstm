...
parser.add_argument(
    "--save-model",
    metavar="<prefix>",
    default='data/model_weights/action_context_best.h5',
    type=str,
...
model = MS_LSTM(INPUT_DIM_1=4096, INPUT_DIM_2=1024, INPUT_LEN=args.temporal_length,  OUTPUT_LEN=args.classes, cells=args.cell)
...
validation_generator_obj = CustomDataGenerator(
    data_path_context=args.context_aware + '/valid/',
...
model.save_weights('data/model_weights/action_context_final.h5')