...
scenes = ['Home','Coffee_room']

for scene in scenes:
    if scene=='Home':
        save_path = 'data/Home_new-pose+score.csv'
        annot_file = 'data/Home_new.csv'  # from create_dataset_1.py
        video_folder = 'data/Home/Videos'
        annot_folder = 'data/Home/Annotation_files'  # bounding box annotation for each frame.
    if scene=='Coffee_room':
        save_path = 'data/Coffee_room_new-pose+score.csv'
        annot_file = 'data/Coffee_room_new.csv'  # from create_dataset_1.py
        video_folder = 'data/Coffee_room/Videos'
        annot_folder = 'data/Coffee_room/Annotation_files'  # bounding box annotation for each frame.
    ...
    for vid in vid_list:
        print(f'Process on: {scene}_{vid}')
