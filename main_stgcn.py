...
from ActionsEstLoader_stgcn import TSSTG


source = 'data/Coffee_room/Videos/video (40).avi'
save_out = 'results/cf_video_40_stgcn.avi'
...
if __name__ == '__main__':
    ...
    frames_label['stgcn_pred_label'] = pred_label
    pred_time = ['']*len(pred_label)
    frames_label['stgcn_pred_time'] = pred_time
    try:
        frames_label.loc[pred_fall_frame-1,'stgcn_pred_time'] = str(anticipation_time)+'s'
    except:
        pass
    if os.path.exists(label_out_csv):
