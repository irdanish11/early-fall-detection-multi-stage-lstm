...
# (1024,1024,30,7)
def MS_LSTM(INPUT_DIM_1,INPUT_DIM_2, INPUT_LEN, OUTPUT_LEN, cells=2048):

    input_vs_sp = Input(shape=(INPUT_LEN, INPUT_DIM_1))
    input_vs_tp = Input(shape=(INPUT_LEN, INPUT_DIM_2))
    ...
    pool_inp_l2 = concatenate([input_vs_tp, do_lstm_l1])
    ...
    MODEL = Model(inputs=[input_vs_sp, input_vs_tp],outputs=[act_lstm_l1, act_lstm_l2])
